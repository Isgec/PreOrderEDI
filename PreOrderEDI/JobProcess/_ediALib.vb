    ...
    Public Shared Function ediALibGetByID(ByVal t_lbcd As String) As SIS.EDI.ediALib
      ...
      Using Con As SqlConnection = New SqlConnection(EDICommon.DBCommon.GetBaaNConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          ...
          EDICommon.DBCommon.AddDBParameter(Cmd, "@t_lbcd", SqlDbType.VarChar, t_lbcd.ToString.Length, t_lbcd)
    ...
    Public Shared Function ediALibSelectList(ByVal StartRowIndex As Integer, ByVal MaximumRows As Integer, ByVal OrderBy As String, ByVal SearchState As Boolean, ByVal SearchText As String) As List(Of SIS.EDI.ediALib)
      ...
      Using Con As SqlConnection = New SqlConnection(EDICommon.DBCommon.GetBaaNConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          ...
          EDICommon.DBCommon.AddDBParameter(Cmd, "@t_acti", SqlDbType.VarChar, 1, True)
    ...
    Public Shared Function InsertData(ByVal Record As SIS.EDI.ediALib) As SIS.EDI.ediALib
      Using Con As SqlConnection = New SqlConnection(EDICommon.DBCommon.GetBaaNConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          ...
          EDICommon.DBCommon.AddDBParameter(Cmd, "@t_desc", SqlDbType.VarChar, 101, Record.t_desc)
          EDICommon.DBCommon.AddDBParameter(Cmd, "@t_serv", SqlDbType.VarChar, 51, Record.t_serv)
          EDICommon.DBCommon.AddDBParameter(Cmd, "@t_path", SqlDbType.VarChar, 51, Record.t_path)
          EDICommon.DBCommon.AddDBParameter(Cmd, "@t_acti", SqlDbType.VarChar, 2, Record.t_acti)
    ...
    Public Shared Function UpdateData(ByVal Record As SIS.EDI.ediALib) As SIS.EDI.ediALib
      Using Con As SqlConnection = New SqlConnection(EDICommon.DBCommon.GetBaaNConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          ...
          EDICommon.DBCommon.AddDBParameter(Cmd, "@Original_t_lbcd", SqlDbType.VarChar, 51, Record.t_lbcd)
          EDICommon.DBCommon.AddDBParameter(Cmd, "@t_lbcd", SqlDbType.VarChar, 51, Record.t_lbcd)
          EDICommon.DBCommon.AddDBParameter(Cmd, "@t_desc", SqlDbType.VarChar, 101, Record.t_desc)
          EDICommon.DBCommon.AddDBParameter(Cmd, "@t_serv", SqlDbType.VarChar, 51, Record.t_serv)
          EDICommon.DBCommon.AddDBParameter(Cmd, "@t_path", SqlDbType.VarChar, 51, Record.t_path)
    ...
    Public Shared Function ediALibDelete(ByVal Record As SIS.EDI.ediALib) As Int32
      ...
      Using Con As SqlConnection = New SqlConnection(EDICommon.DBCommon.GetBaaNConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          ...
          EDICommon.DBCommon.AddDBParameter(Cmd, "@Original_t_lbcd", SqlDbType.VarChar, Record.t_lbcd.ToString.Length, Record.t_lbcd)
          Cmd.Parameters.Add("@RowCount", SqlDbType.Int)
          Cmd.Parameters("@RowCount").Direction = ParameterDirection.Output
          _RecordCount = -1
          Con.Open()
