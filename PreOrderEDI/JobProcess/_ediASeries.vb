    ...
    Public Shared Function ediASeriesGetByID(ByVal t_rnum As Int32) As SIS.EDI.ediASeries
      ...
      Using Con As SqlConnection = New SqlConnection(EDICommon.DBCommon.GetBaaNConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          ...
          EDICommon.DBCommon.AddDBParameter(Cmd, "@t_rnum", SqlDbType.Int, t_rnum.ToString.Length, t_rnum)
    ...
    Public Shared Function InsertData(ByVal Record As SIS.EDI.ediASeries) As SIS.EDI.ediASeries
      Using Con As SqlConnection = New SqlConnection(EDICommon.DBCommon.GetBaaNConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          ...
          EDICommon.DBCommon.AddDBParameter(Cmd, "@t_seri", SqlDbType.VarChar, 51, Record.t_seri)
          EDICommon.DBCommon.AddDBParameter(Cmd, "@t_rnum", SqlDbType.Int, 11, Record.t_rnum)
    ...
    Public Shared Function UpdateData(ByVal Record As SIS.EDI.ediASeries) As SIS.EDI.ediASeries
      Using Con As SqlConnection = New SqlConnection(EDICommon.DBCommon.GetBaaNConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          ...
          EDICommon.DBCommon.AddDBParameter(Cmd, "@Original_t_rnum", SqlDbType.Int, 11, Record.t_rnum)
          EDICommon.DBCommon.AddDBParameter(Cmd, "@t_seri", SqlDbType.VarChar, 51, Record.t_seri)
          EDICommon.DBCommon.AddDBParameter(Cmd, "@t_rnum", SqlDbType.Int, 11, Record.t_rnum)
          EDICommon.DBCommon.AddDBParameter(Cmd, "@t_acti", SqlDbType.VarChar, 2, Record.t_acti)
          EDICommon.DBCommon.AddDBParameter(Cmd, "@t_Refcntd", SqlDbType.Int, 11, Record.t_Refcntd)
    ...
    Public Shared Function ediASeriesDelete(ByVal Record As SIS.EDI.ediASeries) As Int32
      ...
      Using Con As SqlConnection = New SqlConnection(EDICommon.DBCommon.GetBaaNConnectionString())
        Using Cmd As SqlCommand = Con.CreateCommand()
          ...
          EDICommon.DBCommon.AddDBParameter(Cmd, "@Original_t_rnum", SqlDbType.Int, Record.t_rnum.ToString.Length, Record.t_rnum)
          Cmd.Parameters.Add("@RowCount", SqlDbType.Int)
          Cmd.Parameters("@RowCount").Direction = ParameterDirection.Output
          _RecordCount = -1
          Con.Open()
